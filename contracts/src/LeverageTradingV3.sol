...
/**
 * @title LeverageTradingV3
 * @notice Leverage trading with simplified string-based feed IDs
 * @dev Works with PriceOracleV2 using "BTCUSD", "ETHUSD" etc.
 */
contract LeverageTradingV3 is Ownable {
    ...
    constructor(
        ...
        priceOracle = PriceOracleV2(_priceOracle);
    ...
    function setPriceOracle(address newOracle) external onlyOwner {
        ...
        priceOracle = PriceOracleV2(newOracle);
